...
For activating the virtual-environment manually, don't source the settings file directly. Instead, add to `project_env/bin/activate`:
  export EZRQST_HAY__SETTINGS_PATH="/path/to/EZRQST_HAY__env_settings.sh"
  source $EZRQST_HAY__SETTINGS_PATH
...
ENV_SETTINGS_FILE = os.environ['EZRQST_HAY__SETTINGS_PATH']  # set in `httpd/passenger.conf`, and `env/bin/activate`
